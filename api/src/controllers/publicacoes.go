...
func CriarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if erro = repositorio.Criar(publicacao); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
// BuscarPublicacoes traz as publicacao que aparecem no feed do usuario
...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Nao e possivel excluir uma publicacao que nao seja sua"))
		return
	}
